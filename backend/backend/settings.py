...
INCIDENT_EVIDENCE_BUCKET = os.getenv('INCIDENT_EVIDENCE_BUCKET', 'photos')
INCIDENT_EVIDENCE_FOLDER = os.getenv('INCIDENT_EVIDENCE_FOLDER', 'incident-evidence')
INCIDENT_EVIDENCE_MAX_BYTES = int(
    os.getenv('INCIDENT_EVIDENCE_MAX_BYTES', str(10 * 1024 * 1024))
)
