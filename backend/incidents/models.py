...
class Incidents(models.Model):
    INCIDENT_TYPES = [
        ...
        ('Broken streetlights / lack of lighting', 'Broken streetlights / lack of lighting'),
        ('Voltage fluctuations in homes', 'Voltage fluctuations in homes'),
        ('Traffic signal not working', 'Traffic signal not working'),
        ('Overcrowded buses / irregular transport', 'Overcrowded buses / irregular transport'),
        ('Stray dogs / cattle on roads', 'Stray dogs / cattle on roads'),
